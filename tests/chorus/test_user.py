...
class TestUser(ChorusTestCase):
    ...
    def test_create_user(self):
        ...
        self.assertEqual(login_info['response']['user_session']['username'], "test1")
        chorus_session.logout()
        chorus_session.login(self.username, self.password)
        user_session = User(chorus_session)
    ...
    def test_delete_user(self):
        ...
        user_info = user_session.create_user("test2", "secret", "test2", "test2", "test2@alpinenow.com", "title", "dept")
    ...
    def test_get_user_id(self):
        ...
        chorus_session.login(self.username, self.password)
        user_session = User(chorus_session)
        user_id = user_session.get_user_id("chorusadmin")
    ...
    def test_get_user_info(self):
        ...
        chorus_session.login(self.username, self.password)
        user_session = User(chorus_session)
        user_info = user_session.get_user_info("chorusadmin")
